...
const SLUG = "maintenance-seo-basic";
const FALLBACK_HERO = "https://saraya.website/wp-content/uploads/2025/07/Hero-SEO.png";
...
export default async function MaintenanceSeoBasicPage({
  params,
}: {
