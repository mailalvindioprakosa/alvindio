...
const COCOK = [
  { title: "Penyedia Jasa", img: BASE+"2024/08/Frame-5-1.png" },
  { title: "Brand Lokal", img: BASE+"2024/08/Cassana.webp" },
  { title: "Usaha Mandiri", img: BASE+"2024/08/Lenka-Desain.webp" },
];

const FAQ_ITEMS = [
  { q: "Apa itu website UKM?", a: "Website UKM adalah website yang dirancang khusus untuk membantu usaha kecil dan menengah hadir secara digital dengan tampilan profesional, mudah dikelola, dan harga yang terjangkau." },
  { q: "Apakah website UKM bisa menampilkan produk saya?", a: "Ya, website UKM dapat dilengkapi dengan halaman produk, galeri foto, deskripsi layanan, dan informasi kontak agar pelanggan bisa mengenal bisnis Anda lebih baik." },
  { q: "Berapa lama waktu pembuatan website UKM?", a: "Rata-rata pembuatan website UKM membutuhkan waktu 3–5 hari kerja, tergantung jumlah halaman dan tingkat kustomisasi yang diinginkan." },
  { q: "Apakah saya bisa mengelola website sendiri setelah jadi?", a: "Tentu! Kami akan memberikan panduan dan pelatihan singkat agar Anda bisa memperbarui konten, menambah produk, dan mengelola website dengan mudah." },
  { q: "Apakah website UKM akan tampil di Google?", a: "Ya, kami membangun website dengan struktur SEO-friendly sehingga memiliki peluang lebih besar untuk muncul di hasil pencarian Google." },
  { q: "Apakah ada garansi setelah website selesai dibuat?", a: "Ya, kami memberikan garansi dukungan teknis seumur hidup untuk memastikan website Anda selalu berjalan dengan baik." },
  { q: "Apakah desain bisa disesuaikan dengan brand saya?", a: "Tentu! Semua elemen desain akan disesuaikan dengan warna, logo, dan gaya visual brand Anda agar terlihat profesional dan konsisten." },
  { q: "Apakah Website UKM Bisa Dioptimasi untuk SEO?", a: "Ya, website UKM bisa dioptimalkan dengan struktur SEO-friendly, penggunaan keyword yang tepat, dan meta tag agar lebih mudah muncul di hasil pencarian Google." },
];

export default function WebsiteUKM() {
  ...
  return (
    <>
      ...
      <main className="pt-16">
        ...
        {/* HERO — full bg Hero-Saraya (light), split: text left + cards right */}
            ...
            <div className="grid grid-cols-1 lg:grid-cols-5 gap-10 items-center">
              ...
              <div className="lg:col-span-2">
                <h1 className="text-4xl sm:text-5xl font-extrabold leading-tight mb-5" style={{ color: "#200033" }}>
                  Jasa pembuatan website UKM Terbaik
                </h1>
              ...
              <div className="hidden lg:flex lg:col-span-3 items-center justify-center">
                <img src="https://saraya.website/wp-content/uploads/2025/07/Jasa-Website-UMKM.png" alt="Jasa Website UKM" className="w-full max-w-lg drop-shadow-xl" loading="eager" />
              </div>
            </div>
          </div>
        </section>

        {/* CLIENT LOGOS STRIP — 9 kolom, 2 baris, sesuai original */}
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-14 items-center">
              <div className="flex justify-center">
                <img src={BASE+"2025/07/UMKM-About-1024x797.png"} alt="Website Modern untuk UKM" className="max-w-full rounded-2xl shadow-lg" loading="lazy" />
              </div>
              <div>
                <h2 className="text-3xl sm:text-4xl font-extrabold mb-5 leading-snug" style={{ color: "#200033" }}>
                  Website Modern untuk Kembangkan UMKM Masa Kini
                </h2>
                <p className="text-base mb-4 leading-relaxed" style={{ color: "#554B4E" }}>
                  Di era digital yang serba cepat, memiliki website modern bukan lagi pilihan melainkan kebutuhan bagi UMKM. Website bukan sekadar tempat menaruh informasi, melainkan representasi profesional dari bisnis Anda yang bisa diakses kapan saja dan di mana saja.
                </p>
                <p className="text-base leading-relaxed" style={{ color: "#554B4E" }}>
                  Website yang dirancang khusus untuk UMKM membantu membangun kepercayaan, menjelaskan produk atau layanan dengan jelas, dan menciptakan pengalaman pengguna yang menyenangkan.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="py-14" style={{ backgroundColor: "#f9f7ff" }}>
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <blockquote className="text-xl sm:text-2xl font-semibold leading-relaxed" style={{ color: "#200033" }}>
              &ldquo;Bangun Kesan Pertama yang Kuat dengan Website Profesional untuk UMKM Anda.&rdquo;
            </blockquote>
          </div>
        </section>
        ...
        <section className="py-20 bg-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center mb-10">
              <h2 className="text-3xl sm:text-4xl font-extrabold" style={{ color: "#200033" }}>Website UKM cocok untuk siapa?</h2>
              <p className="text-base leading-relaxed" style={{ color: "#554B4E" }}>
                Website UKM cocok untuk berbagai pelaku usaha kecil dan menengah yang ingin membangun kehadiran digital profesional, memperluas jangkauan pelanggan, dan meningkatkan kepercayaan bisnis secara online.
              </p>
            </div>
        ...
        <section className="py-20 bg-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              ...
              <p className="text-sm" style={{ color: "#554B4E" }}>Semua yang perlu Anda ketahui sebelum memulai website UKM yang efektif dan profesional.</p>
            </div>
